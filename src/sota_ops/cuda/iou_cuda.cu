...
TORCH_LIBRARY_IMPL(sota_ops, CUDA, m) {
  m.impl(TORCH_SELECTIVE_NAME("sota_ops::instance_seg_iou_csr"),
         TORCH_FN(instance_seg_iou_csr_cuda));

  m.impl(TORCH_SELECTIVE_NAME("sota_ops::instance_seg_iou"),
         TORCH_FN(instance_seg_iou_cuda));

  m.impl(TORCH_SELECTIVE_NAME("sota_ops::batch_instance_seg_iou"),
