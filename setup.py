...
def get_version() -> str:
    ...
    # write version.py
    with open(cwd / "sota_ops" / "version.py", "w") as f:
...
if __name__ == "__main__":
    ...
    setup(
        ...
        url="https://github.com/vivym/sota-ops",
        download_url="https://github.com/vivym/sota-ops/tags",
        description="Sota Ops",
